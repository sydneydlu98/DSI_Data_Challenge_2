...
Mr_Trash_Wheel <- read_excel("Trash-Wheel-Collection-Totals-8-6-19.xlsx", 
    sheet = "Mr. Trash Wheel")

Professor_Trash_Wheel <- read_excel("Trash-Wheel-Collection-Totals-8-6-19.xlsx", 
    sheet = "Professor Trash Wheel")

Captain_Trash_Wheel <- read_excel("Trash-Wheel-Collection-Totals-8-6-19.xlsx", 
